 ...
 *
 * @see [HTTP Status Code Registry](http://www.iana.org/assignments/http-status-codes)
 *
 * @see [List of HTTP status codes - Wikipedia](http://en.wikipedia.org/wiki/List_of_HTTP_status_codes)
 *
 * @since 3.0
 */
enum class HttpStatus constructor(private val value: Int,
                                  /**
     ...
     *
     * @see [
     * HTTP/1.1: Semantics and Content, section 6.5.9](http://tools.ietf.org/html/rfc7231.section-6.5.9)
     */
    GONE(410, "Gone"),
    /**
     * `411 Length Required`.
     *
     * @see [
     * HTTP/1.1: Semantics and Content, section 6.5.10](http://tools.ietf.org/html/rfc7231.section-6.5.10)
     */
     ...
     *
     * @see [
     * HTTP/1.1: Conditional Requests, section 4.2](http://tools.ietf.org/html/rfc7232.section-4.2)
     */
     ...
     *
     * @see [
     * HTTP/1.1: Semantics and Content, section 6.5.11](http://tools.ietf.org/html/rfc7231.section-6.5.11)
     *
     * @since 4.1
     */
     ...
     *
     * @see [
     * HTTP/1.1: Semantics and Content, section 6.5.12](http://tools.ietf.org/html/rfc7231.section-6.5.12)
     *
     * @since 4.1
     */
     ...
     *
     * @see [
     * HTTP/1.1: Semantics and Content, section 6.5.13](http://tools.ietf.org/html/rfc7231.section-6.5.13)
     */
     ...
     *
     * @see [
     * HTTP/1.1: Semantics and Content, section 6.5.14](http://tools.ietf.org/html/rfc7231.section-6.5.14)
     */
     ...
     * [&#39;org.springframework.http.HttpStatus.Series#INFORMATIONAL&#39;]['org.springframework.http.HttpStatus.Series.INFORMATIONAL'].
    ...
    /**
     * Whether this status code is in the HTTP series
     * [&#39;org.springframework.http.HttpStatus.Series#SUCCESSFUL&#39;]['org.springframework.http.HttpStatus.Series.SUCCESSFUL'].
     * This is a shortcut for checking the value of [.series].
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * [&#39;org.springframework.http.HttpStatus.Series#REDIRECTION&#39;]['org.springframework.http.HttpStatus.Series.REDIRECTION'].
     * This is a shortcut for checking the value of [.series].
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * [&#39;org.springframework.http.HttpStatus.Series#CLIENT_ERROR&#39;]['org.springframework.http.HttpStatus.Series.CLIENT_ERROR'].
     * This is a shortcut for checking the value of [.series].
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * [&#39;org.springframework.http.HttpStatus.Series#SERVER_ERROR&#39;]['org.springframework.http.HttpStatus.Series.SERVER_ERROR'].
     * This is a shortcut for checking the value of [.series].
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * [&#39;org.springframework.http.HttpStatus.Series#CLIENT_ERROR&#39;]['org.springframework.http.HttpStatus.Series.CLIENT_ERROR'] or
     * [&#39;org.springframework.http.HttpStatus.Series#SERVER_ERROR&#39;]['org.springframework.http.HttpStatus.Series.SERVER_ERROR'].
     * This is a shortcut for checking the value of [.series].
     */
    val isError: Boolean
